...
type AdminMember struct {
	...
	NickName     string `gorm:"type:varchar(50);column:nick_name;comment:'닉네임'" json:"nickName"`
	Email        string `gorm:"type:varchar(255);column:email;comment:'이메일 주소'" json:"email"`
	Phone        string `gorm:"type:varchar(20);column:phone;comment:'전화번호'" json:"phone"`
