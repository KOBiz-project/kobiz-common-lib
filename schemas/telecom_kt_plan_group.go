...
type TelecomKTPlanGroup struct {
	...
	CtgNameForMenu       string  `gorm:"column:ctg_name_for_menu; type:varchar(255); not null" json:"ctgNameForMenu"`
	PplGrpNm             string  `gorm:"column:ppl_grp_nm; type:varchar(255); not null" json:"pplGrpNm"`
	PplId                *string `gorm:"column:ppl_id; type:varchar(50)" json:"pplId"`
	PplNm                *string `gorm:"column:ppl_nm; type:varchar(255)" json:"pplNm"`
	...
	OnfrmCd              *string `gorm:"column:onfrm_cd; type:varchar(50)" json:"onfrmCd"`
	...
	ChageDispNo          *string `gorm:"column:chage_disp_no; type:varchar(10)" json:"chageDispNo"`
	DataBasic            *string `gorm:"column:data_basic; type:varchar(255)" json:"dataBasic"`
	DataBenefit          *string `gorm:"column:data_benefit; type:varchar(255)" json:"dataBenefit"`
	TlkBasic             *string `gorm:"column:tlk_basic; type:varchar(255)" json:"tlkBasic"`
	CharBasic            *string `gorm:"column:char_basic; type:varchar(255)" json:"charBasic"`
	TlkBenefit           *string `gorm:"column:tlk_benefit; type:varchar(255)" json:"tlkBenefit"`
	ChageNote            *string `gorm:"column:chage_note; type:text" json:"chageNote"`
	...
	TxtBnfDesc           *string `gorm:"column:txt_bnf_desc; type:text" json:"txtBnfDesc"`
	...
	MTxtBnfDesc          *string `gorm:"column:m_txt_bnf_desc; type:text" json:"mTxtBnfDesc"`
	PrsnlShare           *string `gorm:"column:prsnl_share; type:varchar(10)" json:"prsnlShare"`
	ROAMING              *string `gorm:"column:roaming; type:varchar(10)" json:"rOAMING"`
	...
	PunoMonthUseChage    *string `gorm:"column:puno_month_use_chage; type:varchar(50)" json:"punoMonthUseChage"`
	PunoMonthUseDcChage  *string `gorm:"column:puno_month_use_dc_chage; type:varchar(50)" json:"punoMonthUseDcChage"`
