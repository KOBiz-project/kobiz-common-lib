...
// KTPlanGroup 구조체 정의 (MySQL에 맞게 작성)
// GORM 모델을 사용해 MySQL 데이터베이스의 테이블과 매핑
type TelecomKTPlanGroup struct {
	...
	// CtgNameForMenu: 메뉴용 카테고리 이름
	CtgNameForMenu string `gorm:"column:ctg_name_for_menu; type:varchar(255); not null; comment:'메뉴용 카테고리 이름'" json:"ctgNameForMenu"`
	// PplGrpNm: 요금제 그룹 이름
	PplGrpNm string `gorm:"column:ppl_grp_nm; type:varchar(255); not null; comment:'요금제 그룹 이름'" json:"pplGrpNm"`
	// PplId: 요금제 ID (NULL 허용)
	PplId *string `gorm:"column:ppl_id; type:varchar(50); comment:'요금제 ID'" json:"pplId"`
	// PplNm: 요금제 이름 (NULL 허용)
	PplNm *string `gorm:"column:ppl_nm; type:varchar(255); comment:'요금제 이름'" json:"pplNm"`
	// PplGrpCd: 요금제 그룹 코드
	...
	// OnfrmCd: 확인 코드 (NULL 허용)
	OnfrmCd *string `gorm:"column:onfrm_cd; type:varchar(50); comment:'확인 코드'" json:"onfrmCd"`
	...
	// ChageDispNo: 요금 표시 번호 (NULL 허용)
	ChageDispNo *string `gorm:"column:chage_disp_no; type:varchar(10); comment:'요금 표시 번호'" json:"chageDispNo"`
	// DataBasic: 데이터 기본 제공량 (NULL 허용)
	DataBasic *string `gorm:"column:data_basic; type:varchar(255); comment:'데이터 기본 제공량'" json:"dataBasic"`
	// DataBenefit: 데이터 혜택 (NULL 허용)
	DataBenefit *string `gorm:"column:data_benefit; type:varchar(255); comment:'데이터 혜택'" json:"dataBenefit"`
	// TlkBasic: 통화 기본 제공량 (NULL 허용)
	TlkBasic *string `gorm:"column:tlk_basic; type:varchar(255); comment:'통화 기본 제공량'" json:"tlkBasic"`
	// CharBasic: 문자 기본 제공량 (NULL 허용)
	CharBasic *string `gorm:"column:char_basic; type:varchar(255); comment:'문자 기본 제공량'" json:"charBasic"`
	// TlkBenefit: 통화 혜택 (NULL 허용)
	TlkBenefit *string `gorm:"column:tlk_benefit; type:varchar(255); comment:'통화 혜택'" json:"tlkBenefit"`
	// ChageNote: 요금 노트 (NULL 허용)
	ChageNote *string `gorm:"column:chage_note; type:text; comment:'요금 노트'" json:"chageNote"`
	...
	// TxtBnfDesc: 텍스트 혜택 설명 (NULL 허용)
	TxtBnfDesc *string `gorm:"column:txt_bnf_desc; type:text; comment:'텍스트 혜택 설명'" json:"txtBnfDesc"`
	...
	// MTxtBnfDesc: 모바일 텍스트 혜택 설명 (NULL 허용)
	MTxtBnfDesc *string `gorm:"column:m_txt_bnf_desc; type:text; comment:'모바일 텍스트 혜택 설명'" json:"mTxtBnfDesc"`
	// PrsnlShare: 개인 공유 (NULL 허용)
	PrsnlShare *string `gorm:"column:prsnl_share; type:varchar(10); comment:'개인 공유'" json:"prsnlShare"`
	// ROAMING: 로밍 (NULL 허용)
	ROAMING *string `gorm:"column:roaming; type:varchar(10); comment:'로밍'" json:"rOAMING"`
	...
	// PunoMonthUseChage: 순수 월 사용 요금 (NULL 허용)
	PunoMonthUseChage *string `gorm:"column:puno_month_use_chage; type:varchar(50); comment:'순수 월 사용 요금'" json:"punoMonthUseChage"`
	// PunoMonthUseDcChage: 순수 월 사용 할인 요금 (NULL 허용)
	PunoMonthUseDcChage *string `gorm:"column:puno_month_use_dc_chage; type:varchar(50); comment:'순수 월 사용 할인 요금'" json:"punoMonthUseDcChage"`
...
func (TelecomKTPlanGroup) TableName() string {
	return "telecom_kt_plan_groups"
}
