...
type Member struct {
	...
	SnsType      string `gorm:"column:sns_type;type:ENUM('KAKAO','GOOGLE', 'IDPW'); default:'GOOGLE';comment:'SNS 로그인 타입';uniqueIndex:idx_user" json:"snsType"`
	Password     string `gorm:"column:password;type:varchar(255);comment:'비밀번호'" json:"password"`
