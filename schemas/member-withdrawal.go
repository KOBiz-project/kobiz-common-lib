...
type MemberWithdrawal struct {
	...
	Email        string `gorm:"column:email;type:varchar(255);comment:'가입 이메일'" json:"email"`
	SnsType      string `gorm:"column:sns_type;type:ENUM('KAKAO','GOOGLE'); default:'GOOGLE';comment:'SNS 로그인 타입'" json:"snsType"`
