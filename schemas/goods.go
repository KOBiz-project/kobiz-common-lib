...
type Goods struct {
	...
	NumChgIdPlan            int    `gorm:"column:num_chg_code_plan;type:varchar(256);comment:'번호 이동 요금제 ID'" json:"numChgIdPlan"`
	...
	DeviceChgIdPlan         int    `gorm:"column:device_chg_code_plan;type:varchar(256);comment:'기기 변경 요금제 ID'" json:"deviceChgIdPlan"`
	...
	NewActivationIdPlan     int    `gorm:"column:new_activation_code_plan;type:varchar(256);comment:'신규 개통 요금제 ID'" json:"newActivationIdPlan"`
